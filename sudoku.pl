...
-> Easy:
solve([[3,_,7,_,9,_,_,6,_],[9,5,_,_,_,8,_,_,2],[6,_,_,7,_,_,_,_,_],[_,3,_,_,6,_,_,5,_],[_,_,9,_,_,_,6,_,_],[_,8,_,_,4,_,_,2,_],[_,_,_,_,_,5,_,_,6],[4,_,_,9,_,_,_,1,3],[_,9,_,_,1,_,2,_,7]]).

-> Moderate:
solve([[1,_,_,8,7,_,_,_,_],[_,6,_,_,9,4,_,_,_],[_,_,9,_,_,6,1,_,_],[6,_,_,7,_,_,2,1,_],[4,9,_,_,_,_,_,5,3],[_,2,1,_,_,5,_,_,6],[_,_,4,5,_,_,8,_,_],[_,_,_,9,6,_,_,7,_],[_,_,_,_,4,8,_,_,1]]).

-> Hard:
solve([[_,_,_,4,_,1,_,_,_],[_,_,2,_,_,_,1,_,_],[_,6,_,_,8,_,_,7,_],[4,_,_,_,_,_,_,_,9],[_,_,8,_,_,_,4,_,_],[7,_,_,_,_,_,_,_,5],[_,7,_,_,4,_,_,5,_],[_,_,9,_,_,_,3,_,_],[_,_,_,1,_,3,_,_,_]]).
